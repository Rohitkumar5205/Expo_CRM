...
const OrganicLeadList = () => {
  ...
  const columns = [
    ...
    { label: "Business Type", accessor: "Bussiness.type" }, // Fixed typo: "Bussiness" to "Business"
  ...
  const handleAddNewLeadClick = () => {
    navigate("/organicexpo2026/addnew"); // Updated to match Organic Expo 2026 routing
  };
...
export default OrganicLeadList;
