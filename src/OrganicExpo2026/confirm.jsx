...
const Confirm = () => { // Renamed from Page2 to Confirm
    ...
    const handleConfirmClientClick = () => {
        navigate('/organicexpo2026/confirmclient'); // Updated to self-reference or adjust as needed
    };
                    ...
                    <div className="w-full bg-white shadow-md border-b">
                        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between px-4 py-3">
                            <h1 className="text-xl font-semibold text-gray-700 mb-2 lg:mb-0">
                                ORGANIC EXPO 2026 - CONFIRM CLIENT LIST
                            </h1>
                        </div>
                    </div>
                    <div className="w-full bg-white p-3">
                        <h1 className='text-lg text-[#4f5a67] pl-4 pt-1'>CONFIRM CLIENT LIST</h1>
