  ...
  return (
    <>
      ...
      <div className="w-full h-auto bg-white  px-3 py-2  ">
       <h2 className="text-xl font-semibold text-gray-500 ">ESTIMATE | EDIT</h2>
      </div>
      ...
      <div className="max-w-full  bg-white  mx-8 my-4  rounded-lg">
        <div className="p-4 mx-4">
         <h2 className="text-xl font-semibold text-gray-500  ">Edit Estimate</h2>
          ...
          {items.map((item, index) => (
            <div key={item.id} className="mb-1  bg-gray-50 ">
              ...
              <div className="flex justify-between items-center mb-2">
                 <h4 className="w-full bg-gray-400 text-center text-sm font-semibold text-black">Item No. {index + 1}</h4>
                {items.length > 1 && (
                  <button
                    type="button"
