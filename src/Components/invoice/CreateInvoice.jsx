...
const CreateInvoice = () => {
  ...
  const states =
    country && Citydata[country] ? Object.keys(Citydata[country]) : [];
  const cities =
    country && state && Citydata[country][state]
      ? Citydata[country][state]
      : [];
      ...
      <div className="min-h-screen bg-[#eef1f5] p-4">
        ...
        <div className="w-full bg-white px-4 pb-7 pt-1 shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 text-xs">
            <FormField label="Estimate No." required>
              <input
                ...
                type="text"
                readOnly
                defaultValue="NGW/25-26/EST/112"
              />
            </FormField>
            ...
            <FormField label="Consignee Name" required>
              <input
                className={InputStyle}
                type="text"
                defaultValue="Organic Expo 2026"
              />
            </FormField>
          ...
          <div className="flex gap-2 mt-1 pt-3 border-t border-gray-100">
            <button className="bg-blue-500 text-white font-medium py-2 px-4 text-sm hover:bg-blue-600">
              CREATE INVOICE
            </button>
            <button className="bg-gray-300 text-gray-800 font-medium py-2 px-4 text-sm hover:bg-gray-400">
              CANCEL
            </button>
          </div>
        </div>
