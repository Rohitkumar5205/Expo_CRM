    ...
    <div className="bg-gray-100 p-6 min-h-screen ">
      <div className="max-w-6xl mx-auto bg-white  px-6 py-1">
        ...
        <table className="w-full border-collapse border mb-3">
          ...
          <tbody>
            <tr>
              <td className="border px-1 py-1 text-[10px] font-semibold">
                Client Name
              </td>
            ...
            <tr>
              ...
              <td className="border px-1 py-1 text-[10px]" rowSpan="2">
        ...
        <table className="w-full border-collapse border  mb-3">
          <thead className="bg-[#818481]">
            <tr>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129] w-12">
                S.No.
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]">
                Particulars
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-20">
                HSN Code
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-12">
                Qty.
              ...
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-16">
                Rate
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-20">
                Discount
          ...
          <tbody>
            <tr>
              ...
              <td className="border  px-2 py-1 text-[10px] text-center">
                998596
              </td>
              <td className="border  px-2 py-1 text-[10px] text-center">1</td>
            ...
            <tr>
              <td
                colSpan="8"
                className="border  px-2 py-1 text-[10px] text-right font-semibold"
              >
                Total Taxable Value
              </td>
              <td className="border  px-2 py-1 text-[10px] text-center font-semibold">
                59999
              </td>
            </tr>
          </tbody>
        ...
        <table className="w-full border-collapse border mb-3">
          <thead className="bg-[#818481]">
            <tr>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-30">
                S.No.
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-auto">
                HSN/SAC Details
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-12">
                Qty.
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-24">
                Taxable Value
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  w-20">
                GST Rate
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colSpan="4" className="border px-2 py-1 text-[10px]">
            ...
            <tr>
              <td
                colSpan="7"
                className=" border px-2 py-1 text-[10px] font-semibold align-top"
              >
        ...
        <table className="w-full border-collapse border border-gray-400">
          <thead className="bg-[#818481]">
            <tr>
              <th
                colSpan="2"
                className="border px-2 py-1 text-[10px] text-[#1D2129]  text-left"
              >
                Namo Gange Wellness Pvt. Ltd. Bank Details
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  text-center">
                Client Signature
              </th>
              <th className="border px-2 py-1 text-[10px] text-[#1D2129]  text-center">
          ...
          <tbody>
            <tr>
              <td className=" px-2 py-1 text-[10px] font-semibold w-24">
                Bank Name
              </td>
              <td className=" px-2 py-1 text-[10px]">: Kotak Mahindra Bank</td>
              <td
                rowSpan="4"
                className=" border px-2 text-[10px] text-center align-bottom"
                style={{ height: "80px" }}
              >
        ...
        <div className="flex justify-center text-[10px] pt-2 pb-5 text-gray-900">
