  ...
  return (
     <div className="bg-gray-100 p-6 min-h-screen ">
      <div className="max-w-6xl mx-auto bg-white  px-6 py-1">
       ...
       <div className='flex justify-between sm:text-xs md:text-sm my-2 pl-110 pr-8'>
                ...
                <table className="w-full border-collapse border mb-3">
                    <thead>
                        <tr className="bg-[#818481]">
                            <th colSpan="2" className="border text-center py-1 text-[#1d2129] text-[12px] font-semibold">Buyer's Name & Address</th>
                            <th colSpan="2" className="border text-center py-1 text-[#1d2129] text-[12px] font-semibold">Shipment Details</th>
                            <th colSpan="2" className="border text-center py-1 text-[#1d2129] text-[12px] font-semibold">Seller Invoice Details</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className='border'>
                            <td className=" px-1 py-1 text-[10px] ">Asg Mantra</td>
                            <td className=" px-1 py-1 text-[10px]">Indo-himalayan Expo-2025</td>
                            <td className=" px-1 py-1 font-semibold text-[10px] ">Invoice No.</td>
                            <td className=" px-1 py-1 text-[10px] ">NGW/INV/24-25/026</td>
                        </tr>
                        <tr className='border'>
                            <td className=" px-1 py-1 text-[10px] ">Client Address</td>
                            <td className=" px-1 py-1 text-[10px]" >Naukuchiatal - Bhimtal Road, Bhimtal, Nainital-263136, Uttarakhand, India</td>
                            <td className=" px-1 py-1 text-[10px] ">Designation</td>
                            <td className=" px-1 py-1 text-[10px]">Founder</td>
                            
                        </tr>
                        <tr className='border'>
                            <td className=" px-1 py-1 text-[10px] ">PAN No.</td>
                            <td className=" px-1 py-1 text-[10px] ">Email Id</td>
                            <td className=" px-1 py-1 text-[10px]">joanjoshi999@gmail.com</td>
                            <td className=" px-1 py-1 text-[10px] ">Place of Supply</td>
                            
                        </tr>
                        <tr className='border'>
                            <td className=" px-1 py-1 text-[10px] ">GSTIN</td>
                            <td className=" px-1 py-1 text-[10px]">05AGCPJ7208D1ZW</td>
                            <td className=" px-1 py-1 text-[10px] ">Contact No.</td>
                            <td className=" px-1 py-1 text-[10px]">9868082880</td>
                            <td className=" px-1 py-1 text-[10px] ">State of Supply</td>
