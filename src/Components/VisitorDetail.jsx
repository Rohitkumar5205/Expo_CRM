...
const VisitorDetail = ({ visitor, onBack }) => {
  ...
  const defaultVisitor = {
    ...
    remark: 'I am yoga student from lal bahadur sanskrit vidyapeeth,looking for new things and thats why i want to become the part of this expo',
    company: 'None',
    designation: 'Student'
  };
    ...
    <div className="w-full min-h-screen bg-gray-100 p-4">
      ...
      <div className="w-full bg-white shadow-md border-b mb-6">
        <div className="flex items-center justify-between px-4 py-3">
            <h1 className="text-xl font-semibold text-gray-700 mb-2 lg:mb-0">VISITOR OVERVIEW</h1>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-md shadow border border-gray-200 p-4 mb-6">
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-base font-semibold text-gray-700">Visitor Information</h2>
          ...
          <table className="w-full text-sm border-collapse">
            <tbody>
              ...
              <tr className="bg-gray-50 border-y border-gray-200">
                ...
                <td className="px-2 py-2 w-1/3 text-gray-600">{currentVisitor.name}</td>
                <td className="font-semibold px-2 py-2 w-1/5">Contact No.</td>
                <td className="px-2 py-2 w-1/3 text-gray-600">{currentVisitor.mobile}</td>
              </tr>
              {/* Row 2 */}
              <tr className="border-b border-gray-200">
                <td className="font-semibold px-2 py-2">Email Id</td>
                <td className="px-2 py-2 text-gray-600">{currentVisitor.email}</td>
                <td className="font-semibold px-2 py-2">Remark</td>
                <td className="px-2 py-2 text-gray-600">{currentVisitor.remark || 'No remark provided'}</td>
              </tr>
              {/* Row 3 */}
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-2 py-2 text-gray-600">{currentVisitor.company || 'None'}</td>
                <td className="font-semibold px-2 py-2">Designation</td>
                <td className="px-2 py-2 text-gray-600">{currentVisitor.designation || 'Student'}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="bg-white rounded-md shadow border border-gray-200 p-4 mb-6 text-sm">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              <label className="font-semibold text-gray-700 block mb-1">Previous Status</label>
              <input
                type="text"
